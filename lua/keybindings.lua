...
-- 本地变量, just like #define
local map = vim.api.nvim_set_keymap
-- replace upper-latter V for visual block mode, because <c-v> in windows power shell terminal is system paste
--
map("n","V","<C-v>", opt)
...
-- "moll/vim-bbye" 关闭当前 buffer, can not use for now
